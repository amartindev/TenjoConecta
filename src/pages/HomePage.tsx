...
export function HomePage() {
    ...
    const [mergedFeaturedBusinesses, setMergedFeaturedBusinesses] = useState<
        Business[]
    >([]);
                ...
                if (searchQuery) {
                    ...
                    for (const term of searchTerms) {
                        ...
                        const relatedCategories =
                            keywords[term as keyof typeof keywords];
                        ...
                        if (relatedCategories) {
                            const cats = Array.isArray(relatedCategories)
                                ...
                                : [relatedCategories];
                            conditions.push(
                                ...cats.map((cat) => `category.eq.${cat}`)
                            );
                        } else {
                            conditions.push(
                                `name_unaccent.ilike.%${termNormalized}%`
                            );
                            conditions.push(
                                `description_unaccent.ilike.%${termNormalized}%`
                            );
                        }
                    }
            ...
            !loading &&
                <div className='text-center mb-12'>
                    ...
                    <p className='text-xl text-gray-600 max-w-3xl mx-auto'>
                        Encuentra restaurantes, tiendas y servicios locales.
                        Pide domicilios, contacta directamente por WhatsApp y
                                                ...
                                                >
                                                    <div className='relative h-96'>
                                                        ...
                                                        <div className='absolute bottom-0 left-0 right-0 p-20 pb-7  text-white'>
                                                            ...
                                                            <p className='md:text-lg sm:text-sm mb-4'>
                                                                {
